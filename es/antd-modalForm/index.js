...
var AntdOriginModalForm = /** @class */ (function (_super) {
    __extends(AntdOriginModalForm, _super);
    function AntdOriginModalForm() {
    ...
    AntdOriginModalForm.prototype.render = function () {
    ...
    return AntdOriginModalForm;
}(React.Component));
export { AntdOriginModalForm };
