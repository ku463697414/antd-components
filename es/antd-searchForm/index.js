...
// 默认每行显示的查询条件个数
var COLUMNS = 3;
var AntdOriginSearchForm = /** @class */ (function (_super) {
    __extends(AntdOriginSearchForm, _super);
    function AntdOriginSearchForm() {
    ...
    AntdOriginSearchForm.prototype.render = function () {
    ...
    return AntdOriginSearchForm;
}(React.Component));
export { AntdOriginSearchForm };
